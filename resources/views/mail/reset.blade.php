...
<body>
    <div class="container">
        ...
        <div>
            Gần đây, bạn đã yêu cầu đặt lại mật khẩu cho tài khoản Booking Car của mình. Nhấp vào đường link bên dưới để tiếp tục.
        </div>
        <div><a href="{{ $actionLink }}">Đặt lại mật khẩu</a></div>
        <div>
