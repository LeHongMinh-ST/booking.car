            ...
            <div class="d-flex align-items-center me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('admin.dashboard') }}" class="text-muted text-hover-primary">Khách hàng</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Hồ sơ</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                        ...
                        <div class="modal-body mx-5 mx-xl-15 my-7">
                            <form class="form fv-plugins-bootstrap5 fv-plugins-framework">
                                ...
                                <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                        <span @if($userID) class="required"@endif>Email</span>
                                        @if(!$userID)
                                            <span style="font-weight: 100;font-size: 12px;font-style: italic;">(Nhập email để tạo tài khoản)</span>
                                        @endif
                                    </label>
                                    <!--end::Label-->
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="carousel carousel-custom carousel-stretch slide">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <a href="#" wire:click="openResetModal" class="btn btn-warning me-3 w-100" style="    padding: 0.75rem 1.5rem;">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Image input-->
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ $thumbnail ?? ($imageUpdate != "" ? $imageUpdate : asset('admin/assets/img/default-image.jpg'))}})">
                                    <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $thumbnail ?? ($imageUpdate != "" ? $imageUpdate :  asset('admin/assets/img/default-image.jpg'))}});"></div>
    ...
    <div class="modal fade" id="resetPasswordModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                @livewire('client.customer.reset-password')
                <!--end::Form-->
            </div>
        </div>
    </div>
