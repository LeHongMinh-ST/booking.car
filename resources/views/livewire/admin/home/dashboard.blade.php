                            ...
                            <h3 class="card-title">
                                ...
                                <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                                    <span class="svg-icon svg-icon-3x svg-icon-warning">
                                       <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Shopping/Box1.svg--><svg
