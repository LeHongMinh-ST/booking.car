    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
                                ...
                                @forelse($admins as $admin)
                                    <tr class="odd">
                                        ...
                                        <td class="text-end btnAction">
                                            @if(checkPermission('account-update') && $admin->id != auth('admin')->id())
                                            <span
                                                    wire:click="openResetModal({{$admin->id}})"
                                            ...
                                            @if(checkPermission('account-update') &&  $admin->id != auth()->guard('admin')->user()->id)
                                                <a style="cursor: pointer" href="{{ route('admin.account.edit', $admin->id) }}" class="btn btn-sm btn-clean btn-icon mr-2"
                                                      title="Chỉnh sửa">
        ...
        <div class="modal fade" id="resetPasswordModal" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    @livewire('admin.account.reset-password')
                    <!--end::Form-->
                </div>
            </div>
        </div>
