                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-column mb-10 fv-row">
                                ...
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="1" wire:model="isActive" checked="checked" />
                                    <span class="form-check-label fw-bold text-gray-400">{!! $isActive ? '<span class="text-success">Kích hoạt</span>' : '<span class="text-danger">Khóa</span>' !!}</span>
                                </label>
                                <!--end::Select-->
                            </div>
                            <!--end::Carousel-->
