                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                @forelse($contracts as $contract)
                                    <tr class="odd">
                                        ...
                                        <!--end::Payment method=-->
                                        <!--begin::Date=-->
                                        <td><a href="{{ route('admin.contract.detail', $contract->id) }}">{{ $contract->name }}</a></td>
                                        <td>{{ $contract->code }}</td>
                                        ...
                                        <td class="text-center btnAction">
                                            @if(checkPermission('contract-update') && !empty($contract->user))
                                                <span
                                                        wire:click="openResetModal({{$contract->id}})"
                                            ...
                                            @if(checkPermission('contract-update'))
                                                <a href="{{ route('admin.contract.edit', $contract->id) }}" class="btn btn-sm btn-clean btn-icon mr-2"
                                                   title="Chỉnh sửa">
                                            ...
                                            @if(checkPermission('contract-delete'))
                                                <span
                                                        ...
                                                        wire:click="openDeleteModal({{ $contract->id }})" >
                                                  <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                         height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="modal-dialog modal-dialog-centered mw-450px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_add_contract_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Xóa hợp đồng!</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div wire:click="closeModal" id="kt_modal_add_contract_close"
                        ...
                        <div class="modal-footer flex-center">
                            ...
                            <button wire:click="closeModal" type="reset"
                                    id="kt_modal_add_contract_cancel" class="btn btn-white me-3">Huỷ
                            </button>
                            <!--end::Button-->
                        </div>
                        <!--end::Form-->
