                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <tr class="odd">
                                    ...
                                    <!--begin::Date=-->
                                    <td>{{ $brand->name }}</td>
                                    <td>{!! $brand->is_active ? '<span class="badge badge-success">Kích hoạt</span>' : '<span class="badge badge-danger">Khóa</span>' !!}</td>
                                        ...
                                        <div
                                            ...
                                            @if(checkPermission('brand-update'))
                                                <div class="menu-item px-3">
                                                    <span wire:click="showUpdateModal({{ $brand->id }})" class="menu-link px-3">Sửa</span>
                                                </div>
                                            @endif
                                        <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            @if(checkPermission('brand-delete'))
                                                <div class="menu-item px-3">
                                                    <span  wire:click="openDeleteModal({{ $brand->id }})" class="menu-link px-3"
