                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Image input-->
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ $avatar ?? ($imageUpdate != "" ? $imageUpdate : asset('admin/assets/img/default-image.jpg'))}})">
                                    <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $avatar ?? ($imageUpdate != "" ? $imageUpdate :  asset('admin/assets/img/default-image.jpg'))}});"></div>
    ...
    <div class="modal fade" id="resetPasswordModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                @livewire('admin.profile.profile-reset-password')
                <!--end::Form-->
            </div>
        </div>
    </div>
