    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Danh sách Danh mục</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" role="row">
                                    ...
                                    <th class="min-w-125px"
                                        style="width: 163.734px;">Tên Danh mục
                                    </th>
                                    <th class="min-w-125px"
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit.prevent="store">
                            ...
                            <div class="modal-header" id="kt_modal_add_customer_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">Tạo mới Danh mục</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="required fs-6 fw-bold mb-2">Tên Danh mục</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
            ...
            <div class="modal fade" id="deleteModal"
                ...
                <div class="modal-dialog modal-dialog-centered mw-450px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_add_customer_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Xóa Danh mục</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div wire:click="closeModal" id="kt_modal_add_customer_close"
                                 class="btn btn-icon btn-sm btn-active-icon-primary">
