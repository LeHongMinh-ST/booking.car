        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    @if(checkPermission('product-index'))
                        <div class="menu-item">
                            ...
                            <span class="menu-icon">
                                ...
                                <span class="menu-title">Quản lý Xe thuê</span>
                            </a>
                        </div>
                    @endif
                    @if(checkPermission('category-index'))
                        <div class="menu-item">
                            ...
                            <span class="menu-icon">
                                ...
                                <span class="menu-title">Quản lý Loại xe</span>
                            </a>
                        </div>
                    @endif
                    @if(checkPermission('brand-index'))
                        <div class="menu-item">
                            ...
                            <span class="menu-icon">
                                ...
                                <span class="menu-title">Quản lý Nhãn hiệu</span>
                            </a>
                        </div>
                    @endif
                @endif
                ...
                @if(checkPermission('contract-index') || checkPermission('order-index') || checkPermission('customer-index'))
                    ...
                    @if(checkPermission('contract-index'))
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/contract*') ? 'active' : '' }}"
                               href="{{ route('admin.contract') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Clipboard.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    @if(checkPermission('order-index'))
                        <div class="menu-item">
                        ...
                        <span class="menu-icon">
                            ...
                            <!--end::Svg Icon-->
                                ...
                                <span class="menu-title">Yêu cầu thuê xe</span>
                            </a>
                        </div>
                    @endif

                    @if(checkPermission('customer-index'))
                        <div class="menu-item">
                ...
                @if(checkPermission('post-index') || checkPermission('category-post-index') )
                    <div class="menu-item">
                        <div class="menu-content pt-8 pb-2">
                            <span class="menu-section text-muted text-uppercase fs-8 ls-1">Bài viết</span>
                        </div>
                    </div>
                    @if(checkPermission('post-index'))
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/post*') ? 'active' : '' }}"
                               href="{{ route('admin.post') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Shopping/Box1.svg--><svg
                    ...
                    @endif
                    @if(checkPermission('category-post-index'))
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/category-post*') ? 'active' : '' }}"
                               href="{{ route('admin.category-post') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Shopping/Box2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                @if(checkPermission('statistic-revenue') || checkPermission('statistic-product') )
                    <div class="menu-item">
                        <div class="menu-content pt-8 pb-2">
                            <span class="menu-section text-muted text-uppercase fs-8 ls-1">Thống kê</span>
                        </div>
                    </div>
                    @if(checkPermission('statistic-revenue') )
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/statistic/revenue') ? 'active' : '' }}"
                               href="{{ route('admin.statistic.revenue') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Shopping/Chart-line2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                    ...
                    @endif
                    @if(checkPermission('statistic-product') )
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/statistic/product') ? 'active' : '' }}"
                               href="{{ route('admin.statistic.product') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/stockholm/General/User.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Shopping/Chart-bar2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <!--end::Svg Icon-->
                                ...
                                <span class="menu-title">Thống kê loại xe</span>
                            </a>
                        </div>
                    @endif
                @endif

                @if(checkPermission('account-index') || checkPermission('role-index') )
                    <div class="menu-item">
                        <div class="menu-content pt-8 pb-2">
                            <span class="menu-section text-muted text-uppercase fs-8 ls-1">Hệ thống</span>
                        </div>
                    </div>
                    @if(checkPermission('account-index') )
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('admin/account*') ? 'active' : '' }}"
