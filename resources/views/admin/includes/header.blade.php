                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            @if(auth()->guard('admin')->user()->avatar)
                                <img alt="{{ auth()->guard('admin')->user()->name }}" src="{{ asset(auth()->guard('admin')->user()->avatar) }}" />
                            @else
                                <img alt="{{ auth()->guard('admin')->user()->name }}"  src="{{ asset('admin/assets/media/avatars/150-2.jpg') }}" />
                            @endif
                        </div>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('admin.profile.setting') }}" class="menu-link px-5">Thông tin tài khoản</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
